...
namespace MedievalDocumentation
{
    /// <summary>
    ...
    [HelpFileBuilderPlugInExport("MedievalDocumentation", Version = AssemblyInfo.ProductVersion,
      Copyright = AssemblyInfo.Copyright, Description = "MedievalDocumentation plug-in")]
    public sealed class MedievalDocumentationPlugIn : IPlugIn
    {
        ...
        public void Execute(ExecutionContext context)
        {
            ...
            builder.ReportProgress("In MedievalDocumentationPlugIn Execute() method");
        }
        #endregion
